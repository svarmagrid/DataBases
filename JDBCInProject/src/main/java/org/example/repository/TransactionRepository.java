...
public class TransactionRepository {
    ...
    public void save(Transaction t, String state) {
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            // ------------------------------
            // 3️⃣ Insert state into transaction_details
            // ------------------------------
            ...
            // ------------------------------
            // 5️⃣ Insert merchants if needed
            // ------------------------------
    ...
    """;
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                t.setMerchants(new ArrayList<>()); // Optional: load merchants similarly if needed
                list.add(t);
            }
